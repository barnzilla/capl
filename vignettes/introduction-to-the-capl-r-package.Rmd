...
utils::install.packages(
  pkgs = "https://github.com/barnzilla/r-package-sources/raw/master/capl_1.1.tar.gz",
  repos = NULL, 
  type = "source"
)
library(capl)
...
## Computing CAPL-2 scores and interpretations all at once
...
As a reference, the 40 new variables related to/including the CAPL-2 scores and interpretations that are output from the `get_capl()` function include:
