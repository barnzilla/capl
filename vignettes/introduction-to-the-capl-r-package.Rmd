...
<img src="img/domains-of-physical-literacy.jpg" alt="domains of physical literacy" style="width: 100%; height: auto;">
...
Note: the `validate_gender()` function is called by the `get_capl_interpretation()` to validate/standardize values for the gender variable before performing any computations. There are a number of values that are currently accepted.
